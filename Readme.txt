Unity 2 - Assignment 1

On this project the new features added to the game are:

- When somebody (player or AI) captures an outpost, there is an audio playing.

- If the AI captures the outpost, they dance :)

- If the AI dies, the dead animation is played.
